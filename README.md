...
[![GitHub License](https://img.shields.io/github/license/nlpsandbox/id-annotator-example.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/nlpsandbox/id-annotator-example/blob/main/LICENSE)
...
This repository provides an example implementation of the [NLP Sandbox ID
Annotator API] written in Python-Flask. An NLP Sandbox ID annotator takes as
input a clinical note (text) and outputs a list of predicted ID annotations
found in the clinical note. Here IDs are identified using regular expressions.

This tool is provided to NLP developers who develop in Python as a starting
point to package their own ID annotator as an NLP Sandbox tool (see section
...
The command below starts this NLP Sandbox ID annotator locally.
...
```console
conda create --name id-annotator python=3.9
conda activate id-annotator
```

Install and start this NLP Sandbox ID annotator.
...
This section describes how to develop your own NLP Sandbox ID annotator in
...
[nlpsandbox/id-annotator-example-java].
...
languages and frameworks. Here a ID annotator stub refers to an initial
implementation that has been automatically generated by [openapi-generator] from
the [NLP Sandbox ID Annotator API] specification.
...
Generate the ID annotator stub from an empty GitHub repository (here in
Python-Flask):
...
npx @openapitools/openapi-generator-cli generate \
  -g python-flask \
  -o server \
  -i https://nlpsandbox.github.io/nlpsandbox-schemas/id-annotator/latest/openapi.json
```
...
- `id-annotator` - The type of NLP Sandbox tool to generate. The list of all
...
[docker.synapse.org/syn22277123/id-annotator-example]: https://www.synapse.org/#!Synapse:syn25828638
[Synapse.org]: https://synapse.org
[openapi-generator]: https://github.com/OpenAPITools/openapi-generator
[contribution guide]: .github/CONTRIBUTING.md
[Apache License 2.0]: https://github.com/nlpsandbox/id-annotator-example/blob/main/LICENSE
...
[NLP Sandbox ID Annotator API]: https://nlpsandbox.github.io/nlpsandbox-schemas/id-annotator/latest/docs/
[this GitHub template]: https://github.com/nlpsandbox/id-annotator-example/generate
